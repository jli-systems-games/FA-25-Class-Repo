...
public class BlurredImageEditor : ImageEditor
{
    ...
    private BlurPresetEditor BlurEditor => _blurEditor ??= target is IBlur blur && blur.Common.blurPreset ? (BlurPresetEditor)CreateEditor(blur.Common.blurPreset) : null;
    ...
    public override void OnInspectorGUI()
    {
        ...
        SessionState.SetBool(ShowBlurSectionKey, EditorGUILayout.Foldout(SessionState.GetBool(ShowBlurSectionKey, false), "Advanced Blur", SectionStyle));
        ...
        if (!spriteProperty.hasMultipleDifferentValues && hasSprite)
