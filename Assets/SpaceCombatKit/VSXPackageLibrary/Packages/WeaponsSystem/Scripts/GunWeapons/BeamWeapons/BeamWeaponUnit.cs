...
namespace VSX.Weapons
{
    ...
    public class BeamWeaponUnit : HitScanWeaponUnit
    {
        ...
        // 缓存材质实例以避免每帧创建新副本
        protected Material cachedLineRendererMaterial;
        ...
        protected override void Start()
        {
            ...
            if (lineRenderer != null)
            {
                cachedLineRendererMaterial = lineRenderer.material;
            }
        ...
        protected virtual void LateUpdate()
        {
            ...
            if (beamState != BeamState.Off && cachedLineRendererMaterial != null)
            {
                ...
                cachedLineRendererMaterial.SetTextureOffset(beamRendererTextureKey, new Vector2((Time.time * scrollSpeed) % 1.0f, 0f));
                cachedLineRendererMaterial.SetTextureScale(beamRendererTextureKey, new Vector2(nextTiling, 1));
            }
        ...
        {
            // 清理创建的材质实例
            if (cachedLineRendererMaterial != null)
            {
                Destroy(cachedLineRendererMaterial);
                cachedLineRendererMaterial = null;
            }
        }
    }
