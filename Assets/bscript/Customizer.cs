...
public class Customizer : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Data.data_customizerDress.Clear();
        Data.data_customizerHats.Clear();
        Data.data_customizerShoes.Clear();
        foreach (Sprite sprite in customizerHats)
        {
            Data.data_customizerHats.Add(sprite);
        }
        foreach (Sprite sprite in customizerShoes)
        {
            Data.data_customizerShoes.Add(sprite);
        }
        foreach (Sprite sprite in customizerDress)
        {
            Data.data_customizerDress.Add(sprite);
        }
        #endregion
    }
}
