...
public class CamController : MonoBehaviour
{
    ...
    [SerializeField]
    [Tooltip("Move up")]
    private KeyCode _moveUp = KeyCode.Z;

    [SerializeField]
    [Tooltip("Move down")]
    private KeyCode _moveDown = KeyCode.X;
    ...
    private void Start()
    {
        ...
        Transform[] trs= transform.parent.gameObject.GetComponentsInChildren<Transform>(true);
		foreach(Transform t in trs){
			if(t.name == "Main Camera"){
				mainCamera = t.gameObject;
			}
            if(t.name == "UI"){
                ui = t.gameObject;
            }
